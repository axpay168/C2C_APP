...
require '/www/wwwroot/ilvcoin.top/vendor2/phpmailer/phpmailer/src/Exception.php';
require '/www/wwwroot/ilvcoin.top/vendor2/phpmailer/phpmailer/src/PHPMailer.php';
require '/www/wwwroot/ilvcoin.top/vendo2r/phpmailer/phpmailer/src/SMTP.php';
...
try { 
    ...
    $mail->setFrom('sosu001@163.com', 'NYSE');  //发件人 

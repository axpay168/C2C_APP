...
return [
    ...
    'please bind your bank card first' => '请先绑定您的银行卡',
    'withdrawal amount cannot be empty' => '取款金额不能为空',
    'please contact customer service first' => '请先联系客服',
    'insufficient cash balance' => '现金余额不足',
    'withdrawal application successful' => '提款申请成功',
    'withdrawal failed' => '提现失败',
         
    
    
    'do not apply for real name again' => '请勿重复申请实名',
    'the real name has agreed to do not apply again' => '该实名已同意请勿重新申请',

    ...
    public function index()
    {
        ...
        if ($this->request->isAjax()) {
            ...
            foreach ($list as $k => $row) {
                ...
                $row->getRelation('user')->visible(['username','pid','email','mobile','trfals']);
                
                $list[$k]['topname'] = db::name("user")->where('pid',$row['user_id'])->value("username");
                $list[$k]['wallte'] = \app\admin\model\Wallt::where('uid',$row['user_id'])->find();
            }
